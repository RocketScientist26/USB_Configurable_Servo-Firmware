...
#define SETTINGS_TOTAL_LENGTH (63 + 1 + 4)//Data, CRC padding, CRC
...
#define SETTINGS_DEF_SIGNAL_MAX_MIN 0.5f
#define SETTINGS_DEF_SIGNAL_MAX_MAX 2.7f
#define SETTINGS_DEF_SIGNAL_MAX_DEF 2.0f
#define SETTINGS_DEF_SIGNAL_MIN_MIN 0.1f
#define SETTINGS_DEF_SIGNAL_MIN_MAX (SETTINGS_DEF_SIGNAL_MAX_MAX - (SETTINGS_DEF_SIGNAL_MAX_MIN - SETTINGS_DEF_SIGNAL_MIN_MIN))
#define SETTINGS_DEF_SIGNAL_MIN_DEF 1.0f
